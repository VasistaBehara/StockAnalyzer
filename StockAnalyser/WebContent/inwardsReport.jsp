...
<title>inwards Report</title>
</head>
<body onload="history.forward(1)">
	<ul class="sidenav">
		<li><a href="inwardsAdd.jsp">Add Inwards</a></li>
		<li><a class="active" href="inwardsReport.jsp">Inwards
				Details</a></li>
	...
	<div class="content">
		<font face="Tw Cen MT" color="1234">
			...
			<form align="center" action="inwardsReport.jsp">
		...
		<%
			String godownID = request.getParameter("godownID");
				...
				try {
					...
					rs = st.executeQuery("Select * from inwards  where (dateOfSupply between ('" + startDate
							+ "') and ('" + endDate + "')) and GodownID='" + godownID + "'");
					//ResultSet rs2 = st.executeQuery("Select * from item where itemID=);
		%><font face="Tw Cen MT" color="1234">
			<center>
				<%
					} catch (Exception e) {
