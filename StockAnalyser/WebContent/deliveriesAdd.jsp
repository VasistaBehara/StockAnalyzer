...
<ul class="sidenav">
		<li><a class="active" href="deliveriesAdd.jsp">Add Deliveries</a></li>
		<li><a href="deliveriesReport.jsp">Deliveries Report</a></li>
...
<center>
	<form align="center" action="deliveriesAdd.jsp">
	<%
...
try {
	...
	<h1 align="center" ><u>Add New delivery</u></h1>
		<select name="godown">
...
con1 = DriverManager.getConnection("jdbc:mysql://localhost:3306/stockanalyser", "root", "2513218");
st=con1.createStatement();
String query="insert into delivery(godownID,CID,itemID,dateOfSupply,quantity,dateOfDelivery,receiptNo,bill,CEmpID,invoice) values ('"+godownID+"','"+CID+"','"+itemID+"','"+dateOfSupply+"','"+quantity+"','"+dateOfDelivery+"','"+receiptNo+"','"+bill+"','"+CEmpID+"','"+invoice+"')";
