...
<ul class="sidenav">
		<li><a href="deliveriesAdd.jsp">Add Deliveries</a></li>
		<li><a class="active" href="deliveriesReport.jsp">Deliveries Report</a></li>
...
<%
			...
			<h1 align="center">
				<u>Deliveries Report</u>
			</h1>
		</center>
		<form align="center" action="deliveriesReport.jsp">
			<%
			...
			Ending Date<input type="date" name="endDate" required /> <input
	...
	<%
		...
		try {
			...
			ResultSet rs = st.executeQuery("Select * from delivery  where (dateOfDelivery between ('" + startDate
