...
<body onload="history.forward(1)">
	<ul class="sidenav">
		<li><a href="userView.jsp">View Users</a></li>
		<li><a class="active" href="userDelete.jsp">Delete User</a></li>
 ...
 %>
				...
				<form align="center" action="userDelete.jsp">
					<select name="users">
						...
						%>
						<option value=<%out.println(empName);%>>
							<%
								out.println(empName);
							%>
						</option>
 	...
 	String emp = request.getParameter("users");
 	try {
 		Class.forName("com.mysql.jdbc.Driver");
 		con1 = DriverManager.getConnection("jdbc:mysql://localhost:3306/stockanalyser", "root", "2513218");
 		st = con1.createStatement();
 		String query = "delete from emp where empName='" + emp + "'";
